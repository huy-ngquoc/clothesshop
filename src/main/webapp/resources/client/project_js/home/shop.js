var PRODUCTS = [{
    ...
    },
    {
        ...
        sizes: ["S", "M", "L", "XL"],
        colors: ["Grey", "Beige"],
        img: "https://picsum.photos/seed/p9/800/600"
    },
    {
        id: 10,
        name: "Crop Tee",
        ...
        sizes: ["XS", "S", "M"],
        colors: ["White", "Red"],
        img: "https://picsum.photos/seed/p10/800/600"
    },
    {
        id: 11,
        name: "Denim Jacket",
        ...
        sizes: ["S", "M", "L"],
        colors: ["Blue"],
        img: "https://picsum.photos/seed/p11/800/600"
    },
    {
        id: 12,
        name: "Oxford Shirt",
        ...
        sizes: ["S", "M", "L", "XL"],
        colors: ["White", "Blue"],
        img: "https://picsum.photos/seed/p12/800/600"
    },
    {
        id: 13,
        name: "Track Pants",
        ...
        sizes: ["S", "M", "L"],
        colors: ["Black", "Grey"],
        img: "https://picsum.photos/seed/p13/800/600"
    },
    {
        id: 14,
        name: "Polo Shirt",
        ...
        img: "https://picsum.photos/seed/p14/800/600"
    },
    {
        id: 15,
        name: "Cargo Pants",
        ...
        sizes: ["M", "L", "XL"],
        colors: ["Green", "Brown"],
        img: "https://picsum.photos/seed/p15/800/600"
    },
    {
        id: 16,
        name: "Maxi Dress",
        ...
        sizes: ["XS", "S", "M", "L"],
        colors: ["Red", "Beige"],
        img: "https://picsum.photos/seed/p16/800/600"
    },
    {
        id: 17,
        ...
        sizes: ["M", "L", "XL"],
        colors: ["Navy", "Black"],
        img: "https://picsum.photos/seed/p17/800/600"
    },
    {
        id: 18,
        name: "Knit Cardigan",
        ...
        sizes: ["S", "M", "L"],
        colors: ["Beige", "Brown"],
        img: "https://picsum.photos/seed/p18/800/600"
    },
    {
        id: 19,
        name: "Ribbed Tank",
        ...
        sizes: ["XS", "S", "M"],
        colors: ["White", "Black"],
        img: "https://picsum.photos/seed/p19/800/600"
    },
    {
        id: 20,
        name: "Windbreaker",
        ...
        sizes: ["S", "M", "L"],
        colors: ["Blue", "Grey"],
        img: "https://picsum.photos/seed/p20/800/600"
    },
    {
        id: 21,
        name: "Joggers",
        ...
        sizes: ["S", "M", "L", "XL"],
        colors: ["Grey", "Black"],
        img: "https://picsum.photos/seed/p21/800/600"
    },
    {
        id: 22,
        name: "Flannel Shirt",
        ...
        sizes: ["S", "M", "L", "XL"],
        colors: ["Red", "Brown"],
        img: "https://picsum.photos/seed/p22/800/600"
    },
    {
        id: 23,
        name: "Trench Coat",
        ...
        sizes: ["M", "L", "XL"],
        colors: ["Beige", "Brown"],
        img: "https://picsum.photos/seed/p23/800/600"
    },
    {
        id: 24,
        ...
        sizes: ["M", "L", "XL"],
        colors: ["Brown", "Navy"],
        img: "https://picsum.photos/seed/p24/800/600"
    }
];
...
function applyFilters(products) {
    return products.filter(function(p) {
        ...
        if (state.filters.priceFrom !== null && p.price < state.filters.priceFrom) {
            return false;
        }
        if (state.filters.priceTo !== null && p.price > state.filters.priceTo) {
            return false;
        }

        if (state.filters.sizes.size > 0) {
            var okSize = p.sizes.some(function(s) {
                return state.filters.sizes.has(s);
            });
            if (!okSize) {
                return false;
            }
        ...
        if (state.filters.colors.size > 0) {
            var okColor = p.colors.some(function(c) {
                return state.filters.colors.has(c);
            });
            if (!okColor) {
                return false;
            }
