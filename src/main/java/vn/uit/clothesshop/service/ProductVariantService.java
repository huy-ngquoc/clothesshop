...
public class ProductVariantService {
    ...
    @Nullable
    public ProductVariantUpdateInfoMiddleDto handleCreateMiddleDtoForUpdate(final long id) {
        final var productVariant = this.findProductVariantById(id);
        if (productVariant == null) {
            return null;
        }
    ...
    public boolean updateProductVariantImage(MultipartFile image, long productVariantId) {
