...
public class ProductAdminController {
    ...
    public String getProductPage(
        ...
        final var safePageable = ProductAdminController.productPageableSanitizer.sanitize(pageable);
    ...
    public String getProductDetailPage(
            ...
            @RequestParam(required = false) @Nullable final String q,
            @PageableDefault(size = PagingConstraint.DEFAULT_SIZE) @NonNull final Pageable pageable) {
        final var safePageable = ProductAdminController.productVariantPageableSanitizer.sanitize(pageable);
    ...
    public String getProductCreationPage(
        ...
        final var categoryPaging = ProductAdminController.createPageableForCategory(categoryPage, categorySize);
    ...
    public String createProduct(
            ...
            @RequestParam(required = false) @Nullable final Integer categoryPage,
            @RequestParam(required = false) @Nullable final Integer categorySize,
            @ModelAttribute(ModelAttributeConstant.FORM) @Valid @NonNull final ProductAdminCreationForm form,
    ...
    public String updateProduct(
            ...
            @RequestParam(required = false) @Nullable final Integer categoryPage,
            @RequestParam(required = false) @Nullable final Integer categorySize,
            @ModelAttribute(ModelAttributeConstant.FORM) @Valid ProductAdminInfoUpdateForm form,
            final BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            final var categoryPaging = ProductAdminController.createPageableForCategory(categoryPage, categorySize);
