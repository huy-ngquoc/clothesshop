...
import vn.uit.clothesshop.area.admin.user.service.UserService;
...
import vn.uit.clothesshop.feature.user.domain.spec.UserSpecification;
...
public class UserAdminController {
    ...
    public String getUserPage(
        ...
        final var safePageable = UserAdminController.pageableSanitizer.sanitize(pageable);
