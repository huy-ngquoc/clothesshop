package vn.uit.clothesshop.area.admin.category.controller;
...
import vn.uit.clothesshop.feature.category.infra.jpa.spec.CategorySpecification;
...
public class CategoryAdminController {
    ...
    public CategoryAdminController(
            @NotNull CategoryAdminService categoryService) {
    ...
    public String getCategoryCreationPage(
            final Model model) {
        final var form = new CategoryAdminCreationForm();
    ...
    public String createCategory(
            final Model model,
            @ModelAttribute(ModelAttributeConstant.FORM) @Valid final CategoryAdminCreationForm form,
    ...
    public String updateCategoryInfo(
            final Model model,
            @PathVariable final long id,
            @ModelAttribute(ModelAttributeConstant.FORM) @Valid CategoryAdminInfoUpdateForm form,
            final BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
    ...
    public String updateCategoryImage(
            final Model model,
            @PathVariable final long id,
            @ModelAttribute(ModelAttributeConstant.FORM) final CategoryAdminImageUpdateForm form) {
